    ...
    <ImagesSlider className="h-screen" images={images}>
      <div className="z-50 mx-auto flex h-screen flex-col items-center justify-center px-4 transition-all">
        ...
        <p
          className={cn(
            subtitle(),
            'mb-6 text-center leading-relaxed text-slate-300/90',
          )}
        >
        ...
        <button className="relative inline-flex h-14 items-center justify-center whitespace-nowrap rounded-3xl border-emerald-500/20 bg-emerald-500/10 px-8 text-base font-medium ring-offset-background backdrop-blur-sm transition-colors hover:bg-emerald-300/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
