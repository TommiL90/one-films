            ...
            <ul className="grid gap-6">
              <li>
                <div className="grid gap-1">
                  ...
                  <p className="text-accent-foreground">
                    Engaje seus clientes com nossas campanhas personalizadas nas
                    redes sociais.
                  </p>
                </div>
              </li>
              <li>
                <div className="grid gap-1">
                  ...
                  <p className="text-accent-foreground">
                    Exiba sua marca com um site visualmente deslumbrante e fácil
                    de usar. Desde Landing Pages até E-commerces.
                  </p>
                </div>
              </li>
            </ul>
